...
class FilterCog(commands.Cog):
    ...
    async def apply_filter(self, ctx: commands.Context, filter_name: str):
        ...
        await ctx.send(embed=discord.Embed(description=f"Filter set to **{filter_name}**.", color=discord.Color(0xFFFFFF)))
    ...
    async def enable(self, ctx: commands.Context):
        ...
        embed = discord.Embed(title="Enable Filter", description="Choose a filter to apply:", color=discord.Color(0xFFFFFF))
    ...
    async def disable(self, ctx: commands.Context):
        ...
        await ctx.send(embed=discord.Embed(description="Filter disabled.", color=discord.Color(0xFFFFFF)))
