...
class AiStuffCog(commands.Cog):
    ...
    @discord.app_commands.choices(
        model=[
            ...
            discord.app_commands.Choice(name=' Realistic (Lifelike pictures)', value='REALISTICVS_V20'),
    ...
    async def imagine(self, interaction: discord.Interaction, prompt: str, model: discord.app_commands.Choice[str], sampler: discord.app_commands.Choice[str], negative: str = None, seed: int = None):
        ...
        embed = discord.Embed(color=0xFFFFFF) if is_nsfw else discord.Embed(color=discord.Color(0xFFFFFF))
        ...
        embed.set_footer(text=f"© SALVATION Development", icon_url=self.bot.user.avatar.url)
