...
class General(commands.Cog):
  ...
  @commands.command(name="users", help="checks total users of SALVATION.")
  @blacklist_check()
  @ignore_check()
  @commands.cooldown(1, 3, commands.BucketType.user)
  ...
  async def invite(self, ctx: commands.Context):
      embed = discord.Embed(
          title="SALVATION Integration Hub",
      ...
      embed.add_field(
          name="Quick Actions",
          value=(
              f">>> **[Invite SALVATION](https://discord.com/oauth2/authorize?client_id={self.bot.user.id}&permissions=8&integration_type=0&scope=bot+applications.commands)**\n"
              "**Support Server:** *ask your server admin*"
          ),
          inline=False
      )
      embed.set_footer(
          text="Powered By SALVATION",
