...
class PersonalityModal (discord .ui .Modal ,title ="Set Your AI Personality"):
    def __init__ (self ,ai_cog ,current_personality :str =""):
        ...
        default_prompt ="""You are SALVATION, an intelligent and caring Discord bot assistant created by . Evil ! Rexy .!
...
MY CAPABILITIES:
  SECURITY & MODERATION: Advanced antinuke, automod, member management
...
Ready to have meaningful conversations and help with anything you need! """
        ...
        placeholder ="Describe how you want SALVATION to respond to you...",
    ...
    async def _get_response (self ,message :str ,history :list ,guild_id :int ,user_id :int =None )->str :
        try :
            ...
            if user_personality :
                ...
                system_context .append ({
                "role":"system",
                "content":"You are a Discord bot with many features including moderation, entertainment, music, games, AI capabilities, and utilities. Support server: https://discord.gg/your-server-here"
                })
            else :

                system_context .append ({
                "role":"system",
                "content":f"""You are SALVATION, an intelligent Discord bot created by . Evil ! Rexy ..
...
Support server: https://discord.gg/your-server-here"""
                })
        ...
        if not image_url :
            ...
            async for message in ctx .channel .history (limit =20 ):
                ...
                if ctx .message .content and ctx .message .content .strip ():
                    ...
                    embed =discord .Embed (
                    title =" Image Analysis / Text Analysis",
    ...
    async def handle_trivia_answer (self ,interaction :discord .Interaction ,channel_id :int ,selected_answer :str ):
        ...
        if is_correct
        else f"Incorrect. The answer was **{game['current_answer']}**. Your guess: **{selected_answer}**. -1 point."
        )
