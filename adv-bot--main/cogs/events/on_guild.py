...
class Guild(Cog):
    ...
    async def on_guild_add(self, guild):
        try:
            ...
            ch = int(os.environ["LOG_CHANNEL_ID"]) if os.environ.get("LOG_CHANNEL_ID") else None
            ...
            embed = discord.Embed(title=f"{guild.name}'s Information", color=0xFFFFFF)
