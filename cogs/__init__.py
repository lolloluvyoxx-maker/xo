...
try:
  ...
  AiStuffCog = None
  print(f"[cogs] Skipping /imagine command - optional dependency missing ({e}). "
        f"Run 'pip install prodia' and restart to enable it.")
...
#Extra Optional Events 
  ...
  print(Fore.RED + Style.BRIGHT + "All SALVATION Cogs loaded successfully.")
