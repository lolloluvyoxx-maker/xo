...
class ControlPanelView(ui.View):
    ...
    @ui.button(label="LIMIT", style=discord.ButtonStyle.blurple, row=0, custom_id="j2c:limit")
    ...
    @ui.button(label="PRIVACY", style=discord.ButtonStyle.blurple, row=0, custom_id="j2c:privacy")
    ...
    @ui.button(label="WAITING ROOM", style=discord.ButtonStyle.blurple, row=0, custom_id="j2c:waiting")
    ...
    @ui.button(label="THREAD", style=discord.ButtonStyle.blurple, row=0, custom_id="j2c:thread")
    ...
    @ui.button(label="UNTRUST", style=discord.ButtonStyle.green, row=1, custom_id="j2c:untrust")
    ...
    @ui.button(label="INVITE", style=discord.ButtonStyle.green, row=1, custom_id="j2c:invite")
    ...
    @ui.button(label="KICK", style=discord.ButtonStyle.green, row=1, custom_id="j2c:kick")
    ...
    @ui.button(label="REGION", style=discord.ButtonStyle.green, row=1, custom_id="j2c:region")
    ...
    @ui.button(label="UNBLOCK", style=discord.ButtonStyle.red, row=2, custom_id="j2c:unblock")
    ...
    @ui.button(label="CLAIM", style=discord.ButtonStyle.red, row=2, custom_id="j2c:claim")
    ...
    @ui.button(label="TRANSFER", style=discord.ButtonStyle.red, row=2, custom_id="j2c:transfer")
    ...
    @ui.button(label="DELETE", style=discord.ButtonStyle.red, row=2, custom_id="j2c:delete")
    ...
    @ui.button(label="BLOCK", style=discord.ButtonStyle.danger, row=3, custom_id="j2c:block")
