...
class PlaceholdersView (discord .ui .View ):
    ...
    @discord .ui .button (label ="Show Placeholders",style =discord .ButtonStyle .secondary )
...
└─────────────────────────────────────────┘
    ...
    async def interactive_setup (self ,ctx ,current_settings ):
        ...
        try :
            ...
            f" Thumbnail: {'Yes' if current_settings.get('thumbnail_enabled', True) else 'No'}\n"
            ...
            await ctx .send (" **Level-up image URL** (optional, direct image link)\n"
            ...
            await ctx .send (" **Show user avatar thumbnail in level-up messages?** (yes/no)\n"
            ...
            f" **Level-up Image:** {'Set' if level_image_final else 'None'}\n"
            f" **Show Thumbnail:** {'Yes' if thumbnail_enabled else 'No'}",
            inline =False
            )
    ...
    async def rewards_list (self ,ctx ):
        ...
        try :
            ...
            embed =discord .Embed (title ="Level Rewards",color =0xFFFFFF ,timestamp =datetime .now (timezone .utc ))
    ...
    async def multiplier_list (self ,ctx ):
        ...
        try :
            ...
            embed =discord .Embed (title ="XP Multipliers",color =0xFFFFFF ,timestamp =datetime .now (timezone .utc ))
    ...
    async def blacklist_list (self ,ctx ):
        ...
        try :
            ...
            embed =discord .Embed (title ="Leveling Blacklist",color =0xFFFFFF ,timestamp =datetime .now (timezone .utc ))
    ...
    async def list_level_roles (self ,ctx ):
        ...
        try :
            ...
            embed =discord .Embed (title ="Level Roles",color =0xFFFFFF ,timestamp =datetime .now (timezone .utc ))
